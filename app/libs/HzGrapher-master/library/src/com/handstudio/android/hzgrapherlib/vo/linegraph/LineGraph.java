...
public class LineGraph {
	...
	private int[] coordinateArr = null;
	private int bitmapResource = -1;
	
	public LineGraph(String name, int color, int[] coordinateArr) {
		this.name = name;
		this.color = color;
		this.setCoordinateArr(coordinateArr);
	}
	
	public LineGraph(String name, int color, int[] coordinateArr, int bitmapResource) {
		this.name = name;
		this.color = color;
		this.setCoordinateArr(coordinateArr);
	...
	public void setCoordinateArr(int[] coordinateArr) {
